		...
		<p><b>Your Reservation</b></p><hr class="line">
				...
				<div class="row">					
						<div class="large-12 columns" style="max-width:100%;">
							...
							<span class="fontslabo " style="font-size:32px; text-align:center;">BDT <?php echo $_SESSION['deposit'];?></span>
							<br><span class="fontgrey" style="text-align:center;">Total</span><br>
							<span class="fontslabo" style="font-size:32px; text-align:center;">BDT <?php echo $_SESSION['total_amount'];?></span></p>
